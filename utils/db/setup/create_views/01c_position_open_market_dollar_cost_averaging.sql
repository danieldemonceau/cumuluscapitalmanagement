DROP VIEW IF EXISTS position_open_market_dollar_cost_averaging;

CREATE OR REPLACE VIEW position_open_market_dollar_cost_averaging AS
SELECT
    p.id id,
    p.status "status",
    mt.direction "type",
...
COMMENT ON VIEW position_open_market_dollar_cost_averaging IS E'@name position_open_market_dollar_cost_averaging\n@omit update,delete\nThis is the documentation.';
