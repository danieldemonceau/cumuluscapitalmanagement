DROP VIEW IF EXISTS position_closed_the_acquirers_multiple;

CREATE OR REPLACE VIEW position_closed_the_acquirers_multiple AS
SELECT
    p.id id,
    p.status "status",
    mt.direction "type",
...
COMMENT ON VIEW position_closed_the_acquirers_multiple IS E'@name position_closed_the_acquirers_multiple\n@omit update,delete\nThis is the documentation.';
