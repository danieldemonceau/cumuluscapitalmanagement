...
SELECT
    ...
    e.id exchange_id
FROM (
    VALUES ('VEA', 'Vanguard FTSE Developed Market ETF', '', 'ETF', 'NYSE'),
('VONG', 'Vanguard Russell 1000 Growth ETF', '', 'ETF', 'NYSE'),
('VOO', 'Vanguard S&P 500 ETF', '', 'ETF', 'NYSE'),
('QQQ', 'Invesco QQQ', '', 'ETF', 'NYSE'),
...
('VGK', 'Vanguard FTSE Europe ETF', '', 'ETF', 'NYSE'),
('ICLN', 'iShares Global clean energy ETF', '', 'ETF', 'NYSE'),
('URA', 'Global X Uranium ETF', '', 'ETF', 'NYSE'),
('LIT', 'Global X Lithium & Battery Tech ETF', '', 'ETF', 'NYSE'),
('TAN', 'Invesco Solar ETF', '', 'ETF', 'NYSE')) ss(name, full_name, description, security_type_name, exchange_name)
