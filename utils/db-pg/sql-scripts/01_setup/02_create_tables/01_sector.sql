...
CREATE DOMAIN domain_sector_name TEXT CONSTRAINT constraint_sector_name_predefined NOT NULL CHECK (
    VALUE IN (
        'Energy',
        'Materials',
        'Industrials',
...
CREATE DOMAIN domain_sector_code TEXT CONSTRAINT constraint_sector_name_predefined NOT NULL CHECK (VALUE ~ '^[0-9]{2}$');
