...
CREATE DOMAIN domain_industry_group_name TEXT CONSTRAINT constraint_industry_group_name_predefined NOT NULL CHECK (
    VALUE IN (
        'Energy',
        'Materials',
        'Capital Goods',
...
CREATE DOMAIN domain_industry_group_code TEXT CONSTRAINT constraint_industry_group_name_predefined NOT NULL CHECK (VALUE ~ '^[0-9]{4}$');
