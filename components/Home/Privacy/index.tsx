          ...
          <div className="flex flex-col basis-10/12">
            ...
            <section className="p-10 m-4 flex flex-row">
              <div className="basis-10/12">
                ...
                <h2>2 TYPES OF PERSONAL INFORMATION WE COLLECT</h2>
                <p>
                  The personal information we collect may include the following:
                </p>
                <div className="ml-4">
                  <div>(a) name;</div>
                  <div>(b) mailing or street address; </div>
                  <div>(c) email address;</div>
                  <div>(d) social media information;</div>
                  <div>(e) telephone number and other contact details; </div>
                  <div>(f) age; </div>
                  <div>(g) date of birth;</div>
                  <div>(h) credit card or other payment information;</div>
                  <div>
                    (i) information about your business or personal
                    circumstances;
                  </div>
                  <div>
                    (j) information in connection with client surveys,
                    questionnaires and promotions;{" "}
                  </div>
                  <div>
                    (k) your device identity and type, I.P. address,
                    geo-location information, page view statistics, advertising
                    data and standard web log information;{" "}
                  </div>
                  <div>(l) information about third parties; and </div>
                  <div>
                    (m) any other information provided by you to us via our
                    website or our online presence, or otherwise required by us
                    or provided by you.
                  </div>
                </div>
                ...
                <div className="ml-4">
                  <div>(a) contact us through our website;</div>
                  <div>(b) receive goods or services from us;</div>
                  <div>(c) submit any of our online sign up forms;</div>
                  <div>
                    (d) communicate with us via email, telephone, SMS, social
                    applications
                  </div>
                  <div>
                  ...
                  <div>
                    (e) interact with our website, social applications,
                    services, content and advertising; and
                  </div>
                  <div>
                    (f) invest in our business or enquire as to a potential
                ...
                <div className="ml-4">
                  ...
                  <div>(b) for record keeping and administrative purposes;</div>
                  <div>
                    (c) to provide information about you to our contractors,
                    employees, consultants, agents or other third parties for
                    the purpose of providing goods or services to you;
                  </div>
                  <div>
                    (d) to improve and optimise our service offering and
                    customer experience;
                  </div>
                  <div>
                    (e) to comply with our legal obligations, resolve disputes
                    or enforce our agreements with third parties;
                  </div>
                  <div>
                    (f) to send you marketing and promotional messages and other
                  ...
                  <div>
                    (h) to consider an application of employment from you. We
                    may disclose your personal information to cloud-providers,
                    contractors and other third parties located inside or
                    outside of Australia. If we do so, we will take reasonable
                    steps to ensure that any overseas recipient deals with such
                    personal information in a manner consistent with how we deal
                    with it.
                  </div>
                </div>
                <h2>5 SECURITY</h2>
